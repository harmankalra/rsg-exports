...
import "./partnerwithus.css"; // Importing the CSS file
          ...
          {/* <div className="commitment-container">
            <div className="commitment-content">
              <div className="commitment-text">
                <h3 className="commitment-title">Our Commitment to Excellence</h3>
                <p className="commitment-description">
                  With our advanced facilities and commitment to excellence, we ensure your private labelling journey is
                  seamless and successful.
                </p>
                <p className="commitment-description">
                  We handle everything from design consultation to production and delivery, allowing you to focus on
                  growing your brand.
                </p>
              </div>
              <div className="commitment-image">
                <div className="image-container1">
                  <img src="/placeholder.svg?height=200&width=200" alt="Rice Processing" width={200} height={200} />
                </div>
              </div>
            </div>
          </div> */}
